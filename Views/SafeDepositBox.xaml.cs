	...
	private async void CheckPassword()
	{
		if (number1 == 5 && number2 == 1 && number3 == 8 && number4 == 7)
		{
			...
			if (hasTorch)
			{
				...
				// 确保标签位置和样式一致
				FragmentHintLabel.HorizontalOptions = LayoutOptions.Center;
				FragmentHintLabel.VerticalOptions = LayoutOptions.Center;
				FragmentHintLabel.HorizontalTextAlignment = TextAlignment.Center;
				FragmentHintLabel.VerticalTextAlignment = TextAlignment.Center;
				FragmentHintLabel.Margin = new Thickness(20);
				FragmentHintLabel.Padding = new Thickness(20);
				
				// 设置背景和阴影
				FragmentHintLabel.Background = new SolidColorBrush(Color.FromRgba(0, 0, 0, 0.5));
				FragmentHintLabel.Shadow = new Shadow
				{
					Brush = Brush.Black,
